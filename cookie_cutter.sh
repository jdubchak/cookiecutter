...
echo "For project set up, please type '1' or '2' to proceed to next step when prompted."
...
select yn in "Yes" "No"; do
	case $yn in
		Yes) 
			break;;
		No) 
			echo "Please input relative path to directory you wish to contain your project"
			read rootdir
			cd $rootdir 
			break;;
	esac
